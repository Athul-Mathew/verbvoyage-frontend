                    ...
                    <div className="flex items-start">
                      <div className="flex items-center h-5">
                        <input
                          ...
                          type="checkbox"
                          className="w-4 h-4 border border-cyan-400 rounded bg-cyan-400 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800"
                          required
                        />
                      </div>
